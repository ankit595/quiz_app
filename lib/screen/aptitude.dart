...
class AptiQuiz extends StatefulWidget {
  @override
  _AptiQuizState createState() => _AptiQuizState();
}

class _AptiQuizState extends State<AptiQuiz> {
  ...
  Future<void> _loadQuizData() async {
    try {
      // Load the JSON file
      String jsonData =
      await rootBundle.loadString('assets/questions/apti.json');
